...
SECRET_KEY = 'django-insecure-n8^t&*p!b*_$c$&57$43(vlnvg5e$=bucc-vc*z-$w*3n3b3m_'
...
TEMPLATES = [
    {
        ...
        ##'DIRS': [os.path.join(BASE_DIR, 'staticfiles', 'frontend', 'templates',)],##FUNCIONA PARA LOCAL
